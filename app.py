...
API_KEY = "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"
...
Classify user queries into three types: "code", "explanation", or "strategic/career".
Respond according to type and adapt length:

Short: concise factual answers (1–2 sentences)
Medium: explanatory (1–2 paragraphs)
Long: in-depth, multi-step, or strategic advice (3–5 paragraphs)

Always integrate RK’s expertise when relevant. Format code snippets in proper code blocks.
"""
...
@app.route('/')
def index():
    return render_template('index.html')  # HTML goes inside templates/index.html
...
def chat():
    ...
    try:
        ...
        return jsonify({"reply": "️❌🌐 Connection lost — Please check your internet connection and try again."})
